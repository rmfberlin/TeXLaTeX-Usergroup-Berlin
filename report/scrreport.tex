...
%
\AtBeginDocument{%
	\newcommand{\version}{Version: 0.2 \\im Februar~2018}%
...
\usepackage{microtype}	%	für schönere Microtypografie
%
%
...
\usepackage[svgnames]{xcolor} % für farbige Hintergünde und farbige Schriften
...
\usepackage[%
			style=footnote-dw,%
			sorting=nty,	%	Sortierung des Literaturverzeicnisses nach (n)ame, (t)itle, (y)ear
			backend=biber%
		]%
{biblatex}
...
\chapter{Aufbau  der Gliederung} % (fold)
	...
	Dieses Dokument basiert auf der Report-Klasse von KOMA-Script. \autocite{komascript:doku}	% unser erstes Zitat mit Literaturangabe
